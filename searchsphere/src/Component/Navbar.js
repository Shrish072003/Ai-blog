...
export const Navbar = () => {
  return (
    ...
    <div className='Side_button'><div className='logo_img_1'><div className='div_p'>Chats</div></div></div>
    ...
    <div className='Side_button'><div className='logo_img_7'><div className='div_p'>Keyword Research Tools</div></div></div>
